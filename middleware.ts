...
export function middleware(request: NextRequest) {
  ...
  if (process.env.NODE_ENV === 'production') {
    response.headers.set(
      ...
      [
        "default-src 'self'",
        "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.iyzico.com https://challenges.cloudflare.com https://static.cloudflareinsights.com https://connect.facebook.net https://www.googletagmanager.com https://analytics.tiktok.com https://s.pinimg.com",
        "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
        "font-src 'self' https://fonts.gstatic.com",
        "img-src 'self' data: blob: https://*.fal.media https://fal.media https://v3.fal.media https://fal.run https://storage.googleapis.com https://*.r2.cloudflarestorage.com https://*.r2.dev https://www.facebook.com https://ct.pinterest.com https://www.google-analytics.com",
        "connect-src 'self' https://api.iyzipay.com https://challenges.cloudflare.com https://fpjs.io https://*.fal.media https://fal.run https://www.facebook.com https://www.google-analytics.com https://analytics.tiktok.com https://ct.pinterest.com https://app.posthog.com",
